...
class Page1 extends React.Component{
    ...
    updateData(){
        let url='https://view.inews.qq.com/g2/getOnsInfo?name=wuwei_ww_area_counts&callback=mydata&_='+ (+new Date())
        fetchJsonp(url).then(res=>{
        }).catch(e=>{})  
        let url2='https://view.inews.qq.com/g2/getOnsInfo?name=wuwei_ww_cn_day_counts&callback=myLineData&_='+ (+new Date()) 
        fetchJsonp(url2).then(res=>{
        }).catch(e=>{})  
    }
    setData=mydata=>{
